...
**An improvement to an existing recipe** — fixing a bug in a
published example, tightening DSP, adding a parameter that makes it
more musically useful. Document what changed and why in the PR
description.
...
failure, design a modgui pedal face, or do something else useful for
the same audience.
